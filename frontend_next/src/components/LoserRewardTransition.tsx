...
interface LoserRewardTransitionProps {
    onComplete?: () => void;
}

export default function LoserRewardTransition({ onComplete }: LoserRewardTransitionProps) {
    ...
    useEffect(() => {
        ...
        // 7.5s: Finish the transition (slightly longer to read the text)
                ...
                <AnimatePresence>
                    {phase === 'opened' && (
                        <motion.div
                            ...
                            className="text-center z-30 px-4 max-w-4xl"
                        >
                            <div className="inline-block relative">
                                ...
                                />
                                <h2 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-br from-[#53389e] to-orange-300 mb-6 tracking-widest drop-shadow-[0_0_15px_rgba(83,56,158,0.6)] uppercase leading-tight">
                                    THE REWARD FOR WHAT YOU DID UNTIL
                                </h2>
                            </div>
                            <motion.div
                                animate={{ opacity: [0.4, 1, 0.4] }}
                                transition={{ repeat: Infinity, duration: 2 }}
                                className="text-gray-300 tracking-[0.3em] uppercase text-sm font-semibold mt-12"
                            >
